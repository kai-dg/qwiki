...
class HelpPage(tk.Frame):
    def __init__(self, parent, button):
        ...
        start_here = tk.Label(self.content, bg=s.FG, fg=s.SEARCHFG, text=s.START_HELP,
                              font=(s.FONT1, 12, "bold"))
        place(triangle2, h=0.22, w=0.12, x=0.65, y=0.82)
        place(start_here, h=0.08, w=0.36, x=0.53, y=0.89)
        show_button = tk.Button(self.content, text="Click for more help",
    ...
    def show_more(self):
        ...
        name_help = tk.Label(self.content, bg=s.FG, fg=s.SEARCHFG, text=s.NAME_HELP,
                              font=(s.FONT1, 12, "bold"))
        ...
        searchbar = tk.Label(self.content, bg=s.FG, fg=s.SEARCHFG, text=s.SEARCH_HELP,
                              font=(s.FONT1, 12, "bold"))
